...
public class FormDataHandle extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.print("Full Name:<b> "+ name + "</b><br/>");
        out.print("Phone Number:<b> "+ phNum +"</b><br/>");
        out.print("Gender:<b> "+ gender +"</b><br/>");
        out.print("Programming languages selected:<b> "+ langSelect +"</b><br/>");
        out.print("Duration of course:<b> "+ courseDur+"</b><br/>");
        out.print("Comments:<b> "+ comment+"</b>");
